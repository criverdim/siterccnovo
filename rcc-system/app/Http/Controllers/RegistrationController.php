...
class RegistrationController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'address.required' => 'Informe o logradouro do seu endereço',
            'number.required' => 'Informe o número do seu endereço',
            'district.required' => 'Informe o bairro do seu endereço',
            'city.required' => 'Informe a cidade do seu endereço',
            'state.required' => 'Informe o estado (UF) do seu endereço',
