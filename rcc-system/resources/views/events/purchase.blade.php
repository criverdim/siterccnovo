            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-lg p-6 sticky top-6">
                    ...
                    <form id="purchase-form" class="space-y-6">
                        ...
                        <div class="mt-6">
                            <form action="{{ route('events.payment.process', $event) }}" method="POST" id="purchase-submit-form" class="space-y-4">
                                @csrf
                                <input type="hidden" name="quantity" id="quantity-hidden" value="1">
                                <input type="hidden" name="email" id="email-hidden" value="{{ auth()->user()->email ?? '' }}">
