                ...
                <div class="hidden lg:block lg:col-span-4 bg-gradient-to-br from-emerald-600 to-teal-700 text-white p-12 relative overflow-hidden">
                    <div class="relative z-10 h-full flex flex-col justify-between">
                        ...
                        <div class="pt-8 border-t border-white/20">
                            <p class="text-sm text-emerald-100">&copy; {{ date('Y') }} Renovação Carismática Católica</p>
                        </div>
                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div class="md:col-span-2 group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" name="name" id="name" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="Seu nome completo" value="{{ old('name') }}" required>
                                        </div>
                                    ...
                                    <div class="md:col-span-2 group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="email" name="email" id="email" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="seu@email.com" value="{{ old('email') }}" required>
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="tel" name="phone" id="phone" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="(00) 0000-0000" value="{{ old('phone') }}" required>
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="tel" name="whatsapp" id="whatsapp" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="(00) 00000-0000" value="{{ old('whatsapp') }}" required>
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" name="cpf" id="cpf" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="000.000.000-00" value="{{ old('cpf') }}">
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="date" name="birth_date" id="birth_date" class="block w-full h-11 pl-10 pr-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" value="{{ old('birth_date') }}">
                                        </div>
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="flex items-center gap-4">
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                <input type="radio" name="gender" value="male" class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-500" {{ old('gender') === 'male' ? 'checked' : '' }}>
                                                <span class="text-sm text-gray-700">Masculino</span>
                                            </label>
                                            <label class="inline-flex items-center gap-2 cursor-pointer">
                                                <input type="radio" name="gender" value="female" class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-500" {{ old('gender') === 'female' ? 'checked' : '' }}>
                            ...
                            <div class="space-y-6 pt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-5">
                                    ...
                                    <div class="md:col-span-4 group">
                                        ...
                                        <input type="text" name="complement" id="complement" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="Apto, Bloco..." value="{{ old('complement') }}">
                                    </div>
                                            ...
                                            @foreach($groups as $g)
                                                <label class="relative flex items-start p-3 rounded-xl border border-gray-200 cursor-pointer hover:bg-gray-50 hover:border-emerald-200 transition-all has-[:checked]:border-emerald-500 has-[:checked]:bg-emerald-50/50">
                                                    <div class="flex items-center h-5">
                                                        <input type="checkbox" name="groups[]" value="{{ $g->id }}" class="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500">
                                                    </div>
                                    ...
                                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" id="is_servo" name="is_servo" value="1" class="sr-only peer" {{ old('is_servo') ? 'checked' : '' }}>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                @foreach($ministries as $m)
                                                    <label class="flex items-center p-2 rounded-lg hover:bg-white hover:shadow-sm transition-all cursor-pointer">
                                                        <input type="checkbox" name="ministries[]" value="{{ $m->id }}" class="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500">
                                                        <span class="ml-2 text-sm text-gray-700">{{ $m->name }}</span>
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
