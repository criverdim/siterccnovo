...
<?php $component->withAttributes([]); ?>
    <div class="max-w-md mx-auto p-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status')): ?><div class="p-3 rounded bg-emerald-50 text-emerald-700 mb-3"><?php echo e(session('status')); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /var/www/html/rcc-system/resources/views/auth/passwords/change.blade.php ENDPATH**/ ?>