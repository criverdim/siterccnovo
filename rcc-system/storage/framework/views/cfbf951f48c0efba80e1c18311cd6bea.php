                            ...
                            <div class="space-y-6 pt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-5">
                                    ...
                                    <div class="md:col-span-2 group">
                                        ...
                                        <input type="text" name="cep" id="cep" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="00000-000" value="<?php echo e(old('cep')); ?>" required>
                                    </div>
                                    ...
                                    <div class="md:col-span-4 group">
                                        ...
                                        <input type="text" name="address" id="address" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="Rua, Av..." value="<?php echo e(old('address')); ?>" required>
                                    </div>

                                    <!-- Número -->
                                    <div class="md:col-span-2 group">
                                        <label for="number" class="block text-sm font-medium text-gray-700 mb-1.5">Número <span class="text-red-500">*</span></label>
                                        <input type="text" name="number" id="number" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="123" value="<?php echo e(old('number')); ?>" required>
                                    </div>
                                    ...
                                    <div class="md:col-span-2 group">
                                        ...
                                        <input type="text" name="district" id="district" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="Bairro" value="<?php echo e(old('district')); ?>" required>
                                    </div>
                                    ...
                                    <div class="md:col-span-3 group">
                                        ...
                                        <input type="text" name="city" id="city" class="block w-full h-11 px-3 py-2 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50/50 focus:bg-white" placeholder="Cidade" value="<?php echo e(old('city')); ?>" required>
                                    </div>
