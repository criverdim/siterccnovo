    ...
    <div class="cv-page">
            ...
            <tr>
                <td class="cv-top-right">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($logoDataUri)): ?>
                        <img class="cv-logo" src="<?php echo e($logoDataUri); ?>" alt="Logo">
        ...
        <div class="cv-header">
            <div class="cv-header-left">
                <img class="cv-photo" src="<?php echo e($photoDataUri ?? $user->profile_photo_url); ?>" alt="<?php echo e($user->name); ?>">
            </div>
            <div class="cv-header-right">
                <div class="cv-ident">
                    ...
                    <div class="cv-badges">
                        ...
                        ?>
                        <span class="cv-badge" style="background:<?php echo e($bg); ?>;color:<?php echo e($fg); ?>;border-color:<?php echo e($bd); ?>">Status: <?php echo e($statusLabel); ?></span>
                    </div>
                </div>
            </div>
        </div>
        <table class="cv-content">
            ...
            <div class="cv-block personal">
                ...
                <div class="cv-data">
                    <div class="cv-row"><div class="cv-label">Nome</div><div class="cv-value"><?php echo e($user->name); ?></div></div>
                    <div class="cv-row"><div class="cv-label">Email</div><div class="cv-value"><?php echo e($user->email); ?></div></div>
                    <div class="cv-row"><div class="cv-label">Telefone</div><div class="cv-value"><?php echo e($user->phone ?? 'Não informado'); ?></div></div>
                    <div class="cv-row"><div class="cv-label">WhatsApp</div><div class="cv-value"><?php echo e($user->whatsapp ?? 'Não informado'); ?></div></div>
                    <div class="cv-row"><div class="cv-label">Nascimento</div><div class="cv-value"><?php echo e(optional($user->birth_date)->format('d/m/Y') ?? 'Não informado'); ?></div></div>
                    <div class="cv-row"><div class="cv-label">CPF</div><div class="cv-value"><?php echo e($user->cpf ?? 'Não informado'); ?></div></div>
                    <div class="cv-row2">
                        <div>
                            <div class="cv-label">Função</div>
                            <div class="cv-value"><?php echo e($user->role ?? '—'); ?></div>
                        </div>
                        <div>
                            <div class="cv-label">Servo</div>
                            <div class="cv-value"><?php echo e($user->is_servo ? 'Sim' : 'Não'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cv-data">
                    <div class="cv-row"><div class="cv-label">CEP / Bairro</div><div class="cv-value"><?php echo e($user->cep ?? 'Não informado'); ?> / <?php echo e($user->district ?? 'Não informado'); ?></div></div>
                    <div class="cv-row"><div class="cv-label">Endereço</div><div class="cv-value"><?php echo e($user->address ?? 'Não informado'); ?> <?php echo e($user->number ? ' - '.$user->number : ''); ?> <?php echo e($user->complement ? ' - '.$user->complement : ''); ?></div></div>
                    <div class="cv-row"><div class="cv-label">Cidade / Estado</div><div class="cv-value"><?php echo e($user->city ?? 'Não informado'); ?> / <?php echo e($user->state ?? 'Não informado'); ?></div></div>
                </div>
            </div>
                </td>
                <td class="cv-cell">
            <div class="cv-block groups">
                ...
                <div class="cv-tags">
                    <?php $groupsCount = ($user->groups && $user->groups->count()) ? $user->groups->count() : ($user->group ? 1 : 0); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->groups && $user->groups->count()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $user->groups->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="cv-badge" style="background:<?php echo e($g->color_hex ?? '#10B981'); ?>;color:#0f172a;border-color:#e5e7eb"><?php echo e($g->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->groups->count() > 5): ?>
                            <span class="cv-badge" style="background:#f1f5f9;color:#0f172a">+<?php echo e($user->groups->count() - 5); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php elseif($user->group): ?>
                        <span class="cv-badge" style="background:<?php echo e($user->group->color_hex ?? '#10B981'); ?>;color:#0f172a;border-color:#e5e7eb"><?php echo e($user->group->name); ?></span>
                    <?php else: ?>
                ...
                <div class="cv-tags">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->ministries && $user->ministries->count()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $user->ministries->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="cv-badge" style="background:#f1f5f9;color:#0f172a"><?php echo e($m->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->ministries->count() > 5): ?>
                            <span class="cv-badge" style="background:#f1f5f9;color:#0f172a">+<?php echo e($user->ministries->count() - 5); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php else: ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->activities->count()): ?>
                    <div class="cv-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $user->activities->sortByDesc('created_at')->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cv-note">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->messages->count()): ?>
                    <div class="cv-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $user->messages->sortByDesc('created_at')->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cv-note">
        ...
        <div class="cv-foot">
            <div>
                Cadastrado: <?php echo e(optional($user->created_at)->format('d/m/Y')); ?>

                • Perfil: <?php echo e($user->profile_completed_at ? optional($user->profile_completed_at)->format('d/m/Y') : 'Não completo'); ?>

                • Consentimento: <?php echo e($user->consent_at ? optional($user->consent_at)->format('d/m/Y') : 'Não'); ?>
...
<?php /**PATH /var/www/html/rcc-system/resources/views/admin/users/profile-pdf.blade.php ENDPATH**/ ?>