<?php $__env->startSection('title', 'Contato - RCC System'); ?>
...
<section class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-24">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Entre em <span class="text-blue-300">Contato</span>
        </h1>
...
?>
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">
                                    (11) 9999-9999<br>
                                    <span class="text-sm text-gray-500">Segunda a Sexta, 9h às 18h</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">
                                    contato@rccsystem.com.br<br>
                                    <span class="text-sm text-gray-500">Resposta em até 24h</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <span class="font-semibold text-gray-900">9:00 - 13:00</span>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <p class="text-gray-600 mb-6">Siga-nos para ficar por dentro das novidades!</p>
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="w-12 h-12 bg-green-600 text-white rounded-lg flex items-center justify-center hover:bg-green-700 transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-lg text-gray-600">Venha nos visitar! Estamos localizados no coração de São Paulo.</p>
        </div>
        ...
        <div class="bg-gray-200 rounded-xl overflow-hidden" style="height: 400px;">
            <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
                <div class="text-center">
                    ...
                    <p class="text-gray-500">Integração com Google Maps será implementada</p>
                    <p class="text-sm text-gray-400 mt-2">Rua Exemplo, 1234 - Centro, São Paulo/SP</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Não perca mais tempo! Entre em contato agora mesmo e descubra como podemos 
            transformar suas ideias em realidade.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+5511999999999" class="inline-flex items-center px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                Ligar Agora
            </a>
            <a href="https://wa.me/5511999999999" class="inline-flex items-center px-8 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 transition-colors">
