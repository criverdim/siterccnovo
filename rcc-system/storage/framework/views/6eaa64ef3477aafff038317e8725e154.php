<?php $__env->startSection('title', 'Contato - RCC Miguelópolis'); ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1032800076-0', null);
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">
                                    <?php echo e($address ?: 'Endereço não informado'); ?>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">
                                    <?php echo e($phoneRaw ?: 'Telefone não informado'); ?><br>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">
                                    <?php echo e($email ?: 'Email não informado'); ?><br>
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="<?php echo e($facebook); ?>" target="_blank" rel="noopener" class="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors">
                        ...
                        <a href="<?php echo e($instagram); ?>" target="_blank" rel="noopener" class="w-12 h-12 bg-blue-800 text-white rounded-lg flex items-center justify-center hover:bg-blue-900 transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e($youtube); ?>" target="_blank" rel="noopener" class="w-12 h-12 bg-pink-600 text-white rounded-lg flex items-center justify-center hover:bg-pink-700 transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tiktok): ?>
                        <a href="<?php echo e($tiktok); ?>" target="_blank" rel="noopener" class="w-12 h-12 bg-green-600 text-white rounded-lg flex items-center justify-center hover:bg-green-700 transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gray-200 rounded-xl overflow-hidden" style="height: 400px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($address)): ?>
                <iframe
                    src="https://www.google.com/maps?q=<?php echo e(urlencode($address)); ?>&output=embed"
                    width="100%"
                    height="100%"
                    style="border:0;"
                    allowfullscreen
...
<section class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e($telHref ?? '#'); ?>" class="inline-flex items-center px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                Ligar Agora
            </a>
            <a href="<?php echo e($waHref ?? '#'); ?>" class="inline-flex items-center px-8 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/rcc-system/resources/views/contato.blade.php ENDPATH**/ ?>