    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <?php elseif($participations->count() === 0): ?>
            <div class="text-center py-16">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200">
        ...
        <?php else: ?>
                        ...
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300" data-has-ticket="<?php echo e($participation->ticket_uuid ? '1' : '0'); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($participation->event?->featured_image): ?>
                                <div class="relative h-48 overflow-hidden">
                                    <img src="<?php echo e(Storage::url($participation->event->featured_image)); ?>" alt="<?php echo e($participation->event->name); ?>" class="w-full h-full object-cover">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            
                            <!-- Ticket Info -->
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($participation->event?->name); ?></h3>
                                ...
                                <div class="flex items-center text-gray-600 mb-3">
                                    ...
                                    <span class="text-sm">
                                        <?php echo e(optional($participation->event?->start_date)->format('d/m/Y H:i')); ?>
                                ...
                                <div class="flex items-center text-gray-600 mb-3">
                                    ...
                                    <span class="text-sm"><?php echo e($participation->event?->location); ?></span>
                                </div>
                                
                                <!-- Ticket Code -->
                                <div class="bg-gray-50 rounded-lg p-3 mb-4">
                                    <div class="text-xs text-gray-500 mb-1">UUID do Ingresso</div>
                                    <div class="font-mono text-sm font-bold text-gray-900"><?php echo e($participation->ticket_uuid ?? '—'); ?></div>
                                </div>
                                
                                <!-- Action Buttons -->
                                <div class="space-y-2">
                                    <a href="<?php echo e(route('events.show', $participation->event)); ?>" class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($participation->ticket_uuid): ?>
                                    <a href="/area/ticket/<?php echo e($participation->ticket_uuid); ?>" class="w-full inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Pagination -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($participations->hasPages()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/rcc-system/resources/views/events/my-tickets.blade.php ENDPATH**/ ?>