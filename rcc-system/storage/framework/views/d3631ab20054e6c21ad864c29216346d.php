...
<section class="relative h-[500px] overflow-hidden">
    <div id="heroCarousel" class="carousel-container absolute inset-0">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <img data-slide="<?php echo e($idx); ?>" src="<?php echo e($img); ?>" alt="Slide <?php echo e($idx+1); ?>" class="carousel-slide absolute inset-0 w-full h-full object-cover transition-opacity ease-in-out <?php echo e($idx === 0 ? 'opacity-100' : 'opacity-0'); ?>" style="transition-duration: <?php echo e($transitionMs); ?>ms" onerror="this.src='data:image/svg+xml;charset=UTF-8,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' width=\'1280\' height=\'720\'%3E%3Crect fill=\'%23ecfdf5\' width=\'100%25\' height=\'100%25\'/%3E%3Ctext x=\'50%25\' y=\'50%25\' dominant-baseline=\'middle\' text-anchor=\'middle\' fill=\'%230b7a48\' font-size=\'32\'%3EImagem indispon%C3%ADvel%3C/text%3E%3C/svg%3E'">
    ...
    <div class="absolute z-30 bottom-6 left-0 right-0 flex justify-center space-x-2">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button" data-dot="<?php echo e($i); ?>" aria-label="Slide <?php echo e($i+1); ?>" class="w-2.5 h-2.5 rounded-full <?php echo e($i === 0 ? 'bg-white ring-2 ring-white' : 'bg-white/50'); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    var i=<?php echo e($startRandom ? 'Math.floor(Math.random()*slides.length)' : 0); ?>;
    function show(n){
    ...
    var interval=<?php echo e($speedMs); ?>;
    var autoplay=<?php echo e($autoplay ? 'true' : 'false'); ?>;
    var pauseHover=<?php echo e($pauseHover ? 'true' : 'false'); ?>;
    var direction='<?php echo e($direction === 'backward' ? 'backward' : 'forward'); ?>';
    var timer=null;
    if(autoplay){
    ...
    if(<?php echo e($startRandom ? 'true' : 'false'); ?>){ show(i); }
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/rcc-system/resources/views/home.blade.php ENDPATH**/ ?>