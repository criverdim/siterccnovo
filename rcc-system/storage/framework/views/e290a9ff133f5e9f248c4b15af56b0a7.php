        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 md:h-[4.18rem] lg:h-[5.28rem] overflow-hidden">
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="<?php echo e(url('/calendar')); ?>" class="hover:text-emerald-700 transition-colors" <?php if(request()->is('calendar*')): ?> aria-current="page" <?php endif; ?>>Calendário</a>
                    <a href="<?php echo e(route('events.index')); ?>" class="hover:text-emerald-700 transition-colors" <?php if(request()->is('events*')): ?> aria-current="page" <?php endif; ?>>Eventos</a>
                    <a href="<?php echo e(url('/groups')); ?>" class="hover:text-emerald-700 transition-colors" <?php if(request()->is('groups*')): ?> aria-current="page" <?php endif; ?>>Grupos</a>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-emerald-700 transition-colors">Início</a>
                    <div class="relative group">
                        ...
                        <div class="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-lg border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <a href="<?php echo e(route('sobre')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50">Sobre</a>
                            <a href="<?php echo e(route('servicos')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50">Serviços</a>
                            <a href="<?php echo e(route('contato')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50">Contato</a>
                        </div>
                    </div>
